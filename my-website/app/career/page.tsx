  ...
  const data = [
    {
      ...
      content: (
        <div>
          <p>
            Supports students of masterschool with their hackathon experience.
    ...
    },
    {
      ...
      content: (
        <div>
          <p>
            Conduct Mock Interviews with masterschool computer science students
    ...
    },
    {
      ...
      content: (
        <p>
          UI/UX Design in innovation management. Create websites for innovation
    ...
    },
    {
      ...
      content: (
        <p>
          Created a learning platform using svelte to help students learn
    ...
    },
    {
      ...
      company: "Jetbrains",
      logo: "https://upload.wikimedia.org/wikipedia/en/thumb/0/08/JetBrains_beam_logo.svg/2048px-JetBrains_beam_logo.svg.png",
      content: <p>Represent jetbrains at hackathons. Organize events.</p>,
    },
    {
    ...
    },
    {
      ...
      year: "Jan 2022 - now",
      company: "Freelancing",
      content: <p>Create UI/UX Designs using Figma for clients.</p>,
    },
    {
      ...
      content: <p>Help with organizing the Office and the computers.</p>,
    },
  ];
